...
use crate::{engine::displayengine::DisplayEngine, gui::modal::ResizeData, utils::{log_write, LogLevel}, NON_MAIN_FOCUSED};

/// Returns if the modal should close
pub fn show_resize_modal(ui: &mut egui::Ui, de: &mut DisplayEngine, settings: &mut ResizeData) -> bool {
